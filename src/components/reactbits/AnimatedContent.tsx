...
// AnimatedContent from React Bits (https://reactbits.dev), TS + Tailwind variant.
// Copyright (c) 2026 David Haz. MIT + Commons Clause, see ./LICENSE.md.
// Adapted for Hirehearsal: a failsafe so content is revealed even if the scroll trigger never fires.
